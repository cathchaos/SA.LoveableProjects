...
export default function NewShipmentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const filteredTracking = trackingNumbers.filter(num => num.trim() !== '');
    ...
    const shipment = await createShipment({
      ...
      tracking_numbers: filteredTracking,
    });
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <Label>Tracking Numbers Παραγγελιών (Προαιρετικά)</Label>
                  <Button type="button" variant="outline" size="sm" onClick={handleAddTracking}>
                    Προσθήκη
                  </Button>
                </div>
                <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Προσθέστε τους κωδικούς tracking των παραγγελιών σας για να γνωρίζουμε τι περιμένουμε.
                </p>
              </div>
